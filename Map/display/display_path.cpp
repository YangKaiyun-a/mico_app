...
namespace Display {
DisplayPath::DisplayPath(const std::string &display_type, const int &z_value, std::string parent_name)
...
void DisplayPath::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    drawPath(painter);
}

bool DisplayPath::SetDisplayConfig(const std::string &config_name, const std::any &config_data)
{
