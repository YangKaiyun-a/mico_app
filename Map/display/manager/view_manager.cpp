...
ViewManager::ViewManager(QWidget *parent) : QGraphicsView(parent)
{
    ...
    center_layout->addItem(new QSpacerItem(1, 1, QSizePolicy::Expanding, QSizePolicy::Minimum));
    main_layout->addLayout(center_layout);

    // 底部工具栏水平布局
    QHBoxLayout *bottom_bar_layout = new QHBoxLayout;
    bottom_bar_layout->addItem(new QSpacerItem(1, 1, QSizePolicy::Expanding, QSizePolicy::Minimum));
    ...
    display_config_layout->addItem(new QSpacerItem(1, 1, QSizePolicy::Expanding, QSizePolicy::Minimum));
    left_bar_layout->addItem(display_config_layout);
    left_bar_layout->addItem(new QSpacerItem(1, 1, QSizePolicy::Expanding, QSizePolicy::Expanding));
    ...
    connect(set_big_btn_, &QToolButton::clicked, [this]() {
        display_manager_ptr_->SetScaleBig();
    });
